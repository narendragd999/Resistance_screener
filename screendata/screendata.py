...
def save_to_csv(ticker, data_dict, folder="data"):
    ...
    for table_name, df in data_dict.items():
        ...
        if table_name.lower().startswith('profit_&_loss') or table_name.lower() == 'profit_and_loss':
            file_key = f"{ticker}_profit_loss"
        elif table_name.lower().startswith('quarterly_results') or table_name.lower() == 'quarterly_results':
            file_key = f"{ticker}_quarterly"
        else:
            file_key = f"{ticker}_{table_name}_{timestamp}"
